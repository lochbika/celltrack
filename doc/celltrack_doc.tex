...
\begin{labeling}{clcmassX}
	...
	\item[nXX] The number of track with a certain type (e.g. n10 for track type 10)
\end{labeling}
...
Same as the previous file but containing all tracks of a meta track.
...
\begin{labeling}{clcmassX}
	...
	\item[valSum] The total sum of the key variable (used for cell detection) for the mainstream.
